...
Original file is located at
    https://colab.research.google.com/drive/10TvHUFSb7OOGEqtMVp9c5LB7U3N8hqM8
"""
...
**Engine:** Dijkstra's Algorithm (VROOM) via OpenRouteService.
...
def get_optimized_route(key, addresses):
    ...
    with st.spinner("📏 Drawing final route path..."):
        try:
            ...
            return route_res, stop_order_display
        except Exception as e:
...
if st.button("🚀 Optimize Route", type="primary"):
    if not api_key:
        ...
        geojson_data, stop_order = get_optimized_route(api_key, addr_list)
